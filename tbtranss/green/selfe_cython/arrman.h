...
//
	...
	extern void squ_blkeye(size_t const na, struct blkview const *Ai, float (*A)[na], int const k, float const val);
	extern void dqu_blkeye(size_t const na, struct blkview const *Ai, double (*A)[na], int const k, double const val);
	extern void cqu_blkeye(size_t const na, struct blkview const *Ai, float complex (*A)[na], int const k, float complex const val);
	extern void zqu_blkeye(size_t const na, struct blkview const *Ai, double complex (*A)[na], int const k, double complex const val);

	extern void squ_blkassign(size_t const na, struct blkview const *Ai, float (*A)[na], size_t const mb, size_t const nb, float (*B)[nb]);
	extern void dqu_blkassign(size_t const na, struct blkview const *Ai, double (*A)[na], size_t const mb, size_t const nb, double (*B)[nb]);
	extern void cqu_blkassign(size_t const na, struct blkview const *Ai, float complex (*A)[na], size_t const mb, size_t const nb, float complex (*B)[nb]);
	extern void zqu_blkassign(size_t const na, struct blkview const *Ai, double complex (*A)[na], size_t const mb, size_t const nb, double complex (*B)[nb]);
